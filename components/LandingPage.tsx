...
function Footer() {
  return (
    <footer><div className="footer-main"><div className="footer-brand"><a href="#home" className="logo"><span className="logo-mark">IC</span><span>IRON CORE<small>NUTRITION</small></span></a><p>Performance nutrition for people who put in the work.</p><div className="socials"><a href="#">IG</a><a href="#">YT</a><a href="#">TK</a></div></div><div className="footer-links"><div><strong>EXPLORE</strong><a href="#products">Products</a><a href="#stacks">Stacks</a><a href="#athletes">Athletes</a></div><div><strong>SUPPORT</strong><a href="#">FAQ</a><a href="#">Shipping</a><a href="#">Returns</a></div><div><strong>CONTACT</strong><a href="mailto:train@ironcore.com">train@ironcore.com</a><span>Mon–Fri / 9–5 EST</span></div></div></div><div className="project-credit"><span>Frontend Project</span> Designed &amp; Developed by <strong>Zain Aamir</strong></div><div className="footer-bottom"><span>© 2026 IRON CORE NUTRITION</span><span>FORMULATED FOR THE RELENTLESS.</span><div><a href="#">PRIVACY</a><a href="#">TERMS</a></div></div></footer>
  );
}
